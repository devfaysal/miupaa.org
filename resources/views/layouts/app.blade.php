...
<body class="bg-gray-200 leading-tight">
    <div id="" class="max-w-2xl mx-auto px-6">
        <header class="flex justify-center py-6">
            <h1 class="text-gray-700 text-3xl">MIU Pharmacy Alumni Association</h1>
        </header>
        <main>
            <!--Flash Message Start-->
            @if (Session::has('message'))
                <div id="alert" class="container mt-3">
                    <div class="bg-green-100 border border-green-400 text-green-700 px-4 py-3 rounded relative" role="alert">
                        <span class="block sm:inline">{{ Session::get('message') }}Information submitted successfully!</span>
